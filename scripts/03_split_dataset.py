...
def line_repartitor(jsonl_03, train, test, valid, train_nb_line_ko, train_nb_line_ok, test_nb_line_ko, test_nb_line_ok, valid_nb_line_ko, valid_nb_line_ok, median):
...
def split_jsonl_file(jsonl_03, train, test, valid, jsonl_04, chunk_size, median):
    ...
    line_repartitor(jsonl_04, train, test, valid, train_nb_line_ko, train_nb_line_ok, test_nb_line_ko, test_nb_line_ok, valid_nb_line_ko, valid_nb_line_ok, median)
...
def main(chunk_size, file_id, data_path):
    ...
    median = ecoscore_grad_median(jsonl_03, chunk_size)
    print(f"ecoscore score median: {median}")
    print("start spliting dataset")
    split_jsonl_file(jsonl_03, train, test, valid, jsonl_04, chunk_size, median)
