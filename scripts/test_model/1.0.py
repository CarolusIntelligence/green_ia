...
if __name__ == "__main__":
    train_data = load_jsonl("../../data/10_data/10_train_02.jsonl")
    test_data = load_jsonl("../../data/10_data/10_test_02.jsonl")
    valid_data = load_jsonl("../../data/10_data/10_valid_02.jsonl")
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    train(model, train_loader, valid_loader, epochs=10, lr=1e-5, save_path="best_model.pth")
